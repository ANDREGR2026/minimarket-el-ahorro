...
('direccion',    'Av. Los Próceres 458, Lima',   'Dirección fiscal'),
('telefono',     '987654321',                    'Telefono de contacto'),
...
('Lucía Ramos Peralta',   'cajero', '$2y$10$RM8/FmBegI8rJg9KidMa2ewcm6FiwrvUWGwpEtKk9idMnx0j80bPu', 'cajero@elahorro.pe', 'Cajero', 1),
('Marco Solís Vega',      'almacen', '$2y$10$TX6jHugKh07pK0Vg2kGoWeYTCTYVgLtHNANumlcVXZdiSeUMkdcyK', 'almacen@elahorro.pe', 'Almacenero', 1);
...
('Abarrotes',       'Arroz, azúcar, aceite, fideos y menestras', 1),
('Bebidas',         'Gaseosas, aguas, jugos y energizantes',     1),
('Lácteos',         'Leche, yogurt, queso y mantequilla',        1),
('Snacks',          'Galletas, papas fritas y golosinas',        1),
('Limpieza',        'Detergentes, lejía y útiles de limpieza',   1),
('Cuidado Personal','Jabón, shampoo, pasta dental y papel',      1),
('Panadería',       'Pan, pasteles y productos de panadería',    1),
('Embutidos',       'Jamón, hot dog, chorizo y similares',       1);
...
-- Abarrotes
('7750001000018', 'Arroz Costeño Extra 5 kg',        'Arroz superior embolsado',        1, 18.50, 23.90, 40,  8, 'BOLSA',  1),
('7750001000025', 'Azúcar Rubia Cartavio 1 kg',      'Azúcar rubia doméstica',          1,  3.20,  4.50, 60, 10, 'BOLSA',  1),
...
('7750001000056', 'Lentejas Costeño 500 g',          'Menestra seleccionada',           1,  4.10,  5.60, 25,  6, 'BOLSA',  1),
('7750001000063', 'Atún Florida Filete 170 g',       'Conserva de atún en aceite',      1,  4.90,  6.50, 45, 10, 'LATA',   1),
...
('7753004000026', 'Papas Lays Clásicas 145 g',       'Hojuelas de papa',                4,  5.10,  7.00, 32,  8, 'BOLSA',  1),
...
('7754005000023', 'Lejía Clorox 1 L',                'Hipoclorito de sodio',            5,  3.60,  5.20, 24,  6, 'BOTELLA',1),
...
('7755006000020', 'Jabón Protex 110 g',              'Jabón antibacterial',             6,  2.40,  3.60, 42, 10, 'UNIDAD', 1),
