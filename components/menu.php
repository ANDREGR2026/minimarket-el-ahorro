...
function menu_items()
{
    return [
        ...
        [
            ...
            'ruta'   => 'backups',
            'roles'  => ['Administrador'],
            'icono'  => '<path d="M20.54 5.23 19.15 3.55A1.98 1.98 0 0 0 17.6 3H6.4c-.55 0-1.09.22-1.55.55L3.46 5.23C3.17 5.57 3 6.02 3 6.5V19a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6.5c0-.48-.17-.93-.46-1.27zM12 17.5 6.5 12H10v-2h4v2h3.5L12 17.5zM5.12 5l.81-1h12.14l.94 1H5.12z"/>',
        ],
    ];
}
